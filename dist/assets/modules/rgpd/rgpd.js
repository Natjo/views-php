const Rgpd = a => {
  ...
  b.rel = 'stylesheet', b.href = import.meta.url.replace('.js', '.css'), document.body.appendChild(b), b.onload = () => {
    const b = {
      create(a, b, c) {
        var d = new Date();
    ...
    for (let a in !0 == c ? r = JSON.parse(b.read('rgpd')) : o.forEach(a => r[a.value] = !0), r) for (let b of o) b.value == a && (b.checked = r[a]);
