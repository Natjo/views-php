...
function calcDevice(e) {
  var t = (void 0 === e ? {} : e).userAgent,
    ...
    android: !1
      ...
      c = "Win32" === a,
      v = "MacIntel" === a;
  return !h && v && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(o + "x" + l) >= 0 && ((h = r.match(/(Version)\/([\d.]+)/)) || (h = [0, 1, "13_0_0"]), v = !1), d && !c && (n.os = "android", n.android = !0), (h || u || p) && (n.os = "ios", n.ios = !0), n;
}
...
function updateSlides() {
  ...
  if (void 0 !== s) {
    ...
    for (var C, S = t.slidesPerColumn, M = E / S, $ = Math.floor(d / t.slidesPerColumn), P = 0; P < d; P += 1) {
      ...
      if (t.slidesPerColumn > 1) {
        ...
        if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
          ...
          k = (L = O - (I = Math.floor(O / A)) * A + D * t.slidesPerGroup) + I * E / S, z.css({
      ...
      if ("none" !== z.css("display")) {
        if ("auto" === t.slidesPerView) {
          ...
          if (G && (z[0].style.transform = "none"), B && (z[0].style.webkitTransform = "none"), t.roundLengths) T = this.isHorizontal() ? z.outerWidth(!0) : z.outerHeight(!0);else if (this.isHorizontal()) {
            ...
            if (R && "border-box" === R) T = H + X + _;else {
              var Y = z[0],
                  V = Y.clientWidth;
            ...
            if (J && "border-box" === J) T = q + K + Z;else {
              var Q = z[0],
                  ee = Q.clientHeight;
    ...
    if (this.virtualSize = Math.max(this.virtualSize, s) + f, a && r && ("slide" === t.effect || "coverflow" === t.effect) && i.css({
    ...
    if (0 === h.length && (h = [0]), 0 !== t.spaceBetween && (this.isHorizontal() ? a ? l.filter(c).css({
      marginLeft: w + "px"
    }) : l.filter(c).css({
      marginRight: w + "px"
    }) : l.filter(c).css({
...
function slideTo(e, t, i, s) {
  ...
  var m,
      g = -l[f];
  if (r.updateProgress(g), o.normalizeSlideIndex) for (var w = 0; w < d.length; w += 1) -Math.floor(100 * g) >= Math.floor(100 * d[w]) && (n = w);
  ...
  if (m = n > p ? "next" : n < p ? "prev" : "reset", u && -g === r.translate || !u && g === r.translate) return r.updateActiveIndex(n), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== o.effect && r.setTranslate(g), "reset" !== m && (r.transitionStart(i, m), r.transitionEnd(i, m)), !1;

  if (o.cssMode) {
    var b,
        y = r.isHorizontal(),
        x = -g;
    if (u && (x = c.scrollWidth - c.offsetWidth - x), 0 === t) c[y ? "scrollLeft" : "scrollTop"] = x;else if (c.scrollTo) c.scrollTo(((b = {})[y ? "left" : "top"] = x, b.behavior = "smooth", b));else c[y ? "scrollLeft" : "scrollTop"] = x;
    return !0;
  }
...
function onTouchStart(e) {
  ...
  if (!this.animating || !a.preventInteractionOnTransition) {
    ...
    var o = $(n.target);
    if ("wrapper" !== a.touchEventsTarget || o.closest(this.wrapperEl).length) if (s.isTouchEvent = "touchstart" === n.type, s.isTouchEvent || !("which" in n) || 3 !== n.which) if (!(!s.isTouchEvent && "button" in n && n.button > 0)) if (!s.isTouched || !s.isMoved) if (!!a.noSwipingClass && "" !== a.noSwipingClass && n.target && n.target.shadowRoot && e.path && e.path[0] && (o = $(e.path[0])), a.noSwiping && o.closest(a.noSwipingSelector ? a.noSwipingSelector : "." + a.noSwipingClass)[0]) this.allowClick = !0;else if (!a.swipeHandler || o.closest(a.swipeHandler)[0]) {
...
function onTouchEnd(e) {
  ...
  if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, h = s.followFinger ? r ? t.translate : -t.translate : -i.currentTranslate, !s.cssMode) if (s.freeMode) {
    ...
    if (u > s.longSwipesMs) {
      ...
      "next" === t.swipeDirection && (I >= s.longSwipesRatio ? t.slideTo(P + D) : t.slideTo(P)), "prev" === t.swipeDirection && (I > 1 - s.longSwipesRatio ? t.slideTo(P + D) : t.slideTo(P));
    } else {
...
var checkOverflow$1 = {
  ...
  function e() {
    ...
    var n = this;
    n.support = getSupport(), n.device = getDevice({
      userAgent: i.userAgent
    }), n.browser = getBrowser(), n.eventsListeners = {}, n.eventsAnyListeners = [], void 0 === n.modules && (n.modules = {}), Object.keys(n.modules).forEach(function (e) {
      var t = n.modules[e];
    ...
    }), n.params && n.params.onAny && n.onAny(n.params.onAny), n.$ = $;
    var l = $(n.params.el);
...
var Mousewheel = {
  ...
  animateSlider: function (e) {
    var t = getWindow();
    return !(this.params.mousewheel.thresholdDelta && e.delta < this.params.mousewheel.thresholdDelta) && !(this.params.mousewheel.thresholdTime && now() - this.mousewheel.lastScrollTime < this.params.mousewheel.thresholdTime) && (e.delta >= 6 && now() - this.mousewheel.lastScrollTime < 60 || (e.direction < 0 ? this.isEnd && !this.params.loop || this.animating || (this.slideNext(), this.emit("scroll", e.raw)) : this.isBeginning && !this.params.loop || this.animating || (this.slidePrev(), this.emit("scroll", e.raw)), this.mousewheel.lastScrollTime = new t.Date().getTime(), !1));
  },
  ...
  init: function () {
    ...
    e.a11y.addElId(n, o), s = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite", e.a11y.addElLive(n, s), t.itemRoleDescriptionMessage && e.a11y.addElRoleDescription($(e.slides), t.itemRoleDescriptionMessage), e.a11y.addElRole($(e.slides), "group"), e.slides.each(function (t) {
      var i = $(t);
  ...
  setTranslate: function () {
    var e,
        ...
        u = 0;
    d.shadow && (h ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = $('<div class="swiper-cube-shadow"></div>'), i.append(e)), e.css({
      height: a + "px"
