<header id="header" <?php if ($args["isLight"]) : echo 'class="light"'; endif; ?> role="banner" data-view="header">
    <a href="/" class="logo">
<svg role="img" aria-label="Atream" width="117" height="24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 175 36" style="enable-background:new 0 0 175 36;" xml:space="preserve">
