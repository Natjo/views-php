...
const Rgpd = (onexec) => {
    ...
    style.onload = () => {
        ...
        const cookie = {
            ...
            eraseUnused() {
                for (let checkbox of checkboxes) {
                    !checkbox.checked &&
                        checkbox.dataset.cookies
                            .split(",")
                            .forEach((val) => cookie.erase(val));
                }
            },
        };
        ...
        modal.innerHTML = document.getElementById("rgpd-modal").innerHTML;
        ...
        manage.className = "rgpd-manage";
        manage.innerHTML = document.getElementById("rgpd-manage").innerHTML;
        ...
        const status = () =>
            checkboxes.forEach(
                (item) => (cats[item.value] = item.checked ? true : false)
            );
        ...
        btn_details.forEach(
            (btn) => (btn.onclick = () => btn.classList.toggle("active"))
        );
        ...
        const open = () => {
            ...
            manage.addEventListener(
                "animationend",
                (e) => window.addEventListener(clicktouch, clickoutside),
                { once: true }
            );
